...
//   return (
//     <div className="bg-white rounded-t-3xl mt-44 h-[32rem] w-full shadow-lg">
//       {/* Header Section */}
//       <div className="px-6 py-4 flex justify-between items-center">
//         <h2 className="text-base font-semibold">Chilli Chicken</h2>
//         <button>
...
//           <label
//             className={`flex items-center justify-between border p-3 rounded-lg ${
//               selectedOption === "spicy" ? "border-red-500" : "border-gray-300"
//             }`}
//           >
//             <span>Chilly Chicken Dry (Spicy)</span>
//             <span className="ml-12 text-sm text-gray-600">₹389</span>
//             <input
//               type="radio"
//               name="chilli-chicken"
//               value="spicy"
//               checked={selectedOption === "spicy"}
//               onChange={() => setSelectedOption("spicy")}
//               className="form-radio text-red-600 accent-red-600"
//             />
//           </label>
//           <label
//             className={`flex items-center justify-between border p-3 rounded-lg ${
//               selectedOption === "mild" ? "border-red-500" : "border-gray-300"
//             }`}
//           >
//             <span>Chilly Chicken Dry (Mild Spicy)</span>
//             <span className="ml-2 text-sm text-gray-600">₹399</span>
//             <input
//               type="radio"
//               name="chilli-chicken"
//               value="mild"
//               checked={selectedOption === "mild"}
//               onChange={() => setSelectedOption("mild")}
//               className="form-radio text-red-600 accent-red-600"
//             />
//           </label>
//         </div>
...
//       {/* Footer Section */}
//       <div className="flex justify-between items-center px-6 py-4 border-t bg-gray-50 mt-40">
//         <div className="flex items-center border-2 border-[#999999] rounded-lg px-4 py-2 text-red-600">
//           <button
//             onClick={() => setCount(Math.max(count - 1, 1))}
...
//           </button>
//           <span className="px-4 text-xl ">{count}</span>
//           <button onClick={() => setCount(count + 1)} className="text-red-600">
//             <FaPlus />
//           </button>
//         </div>
//         <button className="bg-red-600 text-white px-8 py-3 rounded-lg text-lg font-semibold">
//           Add Item | ₹{price * count}
//         </button>
//       </div>
//     </div>
